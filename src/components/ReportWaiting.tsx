...
const SYSTEM_CAROUSEL = [
  {
    system: '八字四柱',
    emoji: '🀄',
    text: '八字是您的"先天出厂设置"——年柱定根骨、月柱观天赋、日柱见本我、时柱看志向。它将解读您的五行元素配比和运势走势，帮您理解为什么有些事情天生顺手，有些则需要刻意修炼。',
  },
  {
    system: '人类图',
    emoji: '🧬',
    text: '人类图是您的"能量使用说明书"——揭示您是建设者、投射者、显示者还是反映者。它将告诉您如何做决策最省力（权威策略），以及您与生俱来的天赋通道在哪些领域发光。',
  },
  {
    system: '紫微斗数',
    emoji: '⭐',
    text: '紫微斗数是您的"人生十二宫地图"——命宫定格局、夫妻宫看关系、财帛宫观财富、官禄宫见事业。十四主星落于各宫，排列出您一生的重要课题和高光时刻。',
  },
  {
    system: '占星星盘',
    emoji: '🔭',
    text: '星盘是您的"宇宙出生快照"——太阳星座显意识自我，月亮星座见情绪底色，上升星座是您与世界的接口。行星相位揭示内在张力与天赋，是理解情绪模式的重要线索。',
  },
  {
    system: '五运六气',
    emoji: '🌊',
    text: '五运六气是您与天地节律的共振频率——出生年份决定了您的"运气密码"，揭示先天体质偏向、脏腑盛衰以及不同年份的健康重点。了解它，就是拿到了身体的预防手册。',
  },
  {
    system: 'MBTI人格',
    emoji: '🧠',
    text: 'MBTI是您的"思维操作系统"——从能量来源（E/I）、信息接收（S/N）、决策方式（T/F）、生活态度（J/P）四个维度定位您的认知偏好。交叉验证其他系统的结论，让自我认知更立体。',
  },
  {
    system: '中医体质',
    emoji: '🌿',
    text: '中医体质是您的"身体底色"——平和质、气虚质、阳虚质、阴虚质、痰湿质、湿热质、血瘀质、气郁质、特禀质，九种体质对应不同的饮食、作息和调理策略，让您学会"治未病"。',
  },
];
