...
// ── 星运 (§7: 总笔画→星运) ──
const XINGYUN: Record<number,string>={21:'争权星',24:'福德星',30:'经营星',33:'背景星',36:'领袖星'};
const XINGYUN_DESC: Record<number,string>={
  21:'在斗争中成凤凰，带动力超强',24:'贵人照顾，绝处逢生',
  30:'最会经营财富，最怕思多行少',33:'借光发亮，最忌独闯',36:'最易出CEO'
};
