...
const STROKE_MAP: Record<string, number> = {
  ...
  '博':12, '彬':11, '君':7, '峰':10, '毅':15, '恒':10, '志':7, '宏':7, '辉':15, '飞':9,
  '翔':12, '凤':14, '麒':19, '麟':23, '鹏':19, '鲲':19, '鸿':17, '雁':15, '春':9, '秋':9,
  '冬':5, '晨':11, '曦':20, '旭':6, '阳':17, '月':4, '星':9, '雪':11, '雨':8, '云':12,
  '风':9, '霜':17, '露':20, '虹':9, '霓':16, '天':4, '地':6, '山':3, '水':4, '火':4,
  '海':11, '河':9, '湖':13, '川':3, '树':16, '花':10, '草':10, '梅':11, '兰':23, '竹':6,
  '菊':14, '松':8, '柏':9, '柳':9, '子':3, '女':3, '儿':8, '小':3, '大':3, '中':4,
  '国':11, '家':10, '人':2, '心':4, '光':6, '德':15, '仁':4, '义':13, '礼':18, '智':12,
  '信':9, '善':12, '美':9, '和':8, '安':6, '乐':15, '福':14, '寿':14, '喜':12, '庆':15,
  '吉':6, '祥':11, '雅':12, '若':11, '如':6, '意':13, '思':9, '想':13, '知':8, '道':16,
  '行':6, '为':12, '我':7, '你':7, '他':5, '们':10, '这':11, '那':7, '什':4, '么':3,
  '怎':9, '样':15, '东':8, '西':6, '南':9, '北':5, '前':9, '后':9, '左':5, '右':5,
  '上':3, '下':3, '日':4, '年':6, '时':10, '分':4, '秒':9, '今':4, '昨':9, '是':9,
  '有':6, '不':4, '在':6, '了':2, '来':8, '去':5, '出':5, '进':11, '回':6, '可':5,
  '以':5, '要':9, '会':13, '能':10, '用':5, '对':14, '好':6, '很':9, '都':14, '说':14,
  '看':9, '见':7, '听':22, '闻':14, '问':11, '答':12, '讲':17, '读':22, '写':15, '话':13,
  '言':7, '语':14, '诗':13, '词':12, '歌':14, '曲':6, '画':8, '书':10, '字':6, '学':16,
  '校':10, '师':10, '生':5, '课':15, '考':6, '试':13, '题':18, '习':11, '数':15, '理':12,
  '化':4, '物':8, '科':9, '技':8, '工':3, '农':13, '商':11, '医':15, '药':19, '爱':13,
  '情':12, '恨':10, '怒':8, '哀':9, '忧':15, '愁':13, '木':4, '土':3, '珠':11, '宝':20,
  '银':14, '红':9, '蓝':20, '绿':14, '青':8, '紫':11, '黑':12, '灰':6, '彩':11, '身':7,
  '体':23, '头':16, '手':4, '足':7, '眼':11, '耳':6, '口':3, '鼻':14, '舌':6,
};
...
export function calcJiugong(name: string, year: number, month?: number, day?: number): JiugongResult {
  ...
  const tezhiRaw = TEZHI_TYPES[zongNum] || TEZHI_TYPES[5];
  const tezhi = { number: zongNum, ...tezhiRaw };
  const chars = [...name.replace(/\s/g,'')];
