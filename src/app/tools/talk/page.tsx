...
const talkCards: TalkCard[] = [
  {
    ...
    questions: [
      '如果这位先贤来到我们面前，您觉得他最想对我们说什么？',
      '为什么那么多有学问的人都在研究这个人？您觉得他有什么特别之处？',
      '您说说看，有哪一件事是这个人做的，而您觉得自己也能做到？',
      '如果让您用一个词形容他，您会用什么词？为什么？',
      '您觉得他小时候会是个什么样的孩子？跟您像吗？',
      '他的故事里，最让您意外的一件事是什么？',
      '如果他是您的同桌，您们会成为好朋友吗？为什么？',
    ],
  },
  {
    theme: '深挖理解',
    ...
    questions: [
      '他人生最难的时候，是什么支撑了他？如果是您，您会怎么做？',
      '您觉得他的哪一个选择最了不起？为什么这个选择很难？',
      '如果把他放在今天的昌宁茶山上，他会做什么？',
      '他有没有做过让您觉得"这人也太厉害了吧"的事？是什么？',
      '您觉得他有没有害怕过？他是怎么面对害怕的？',
      '如果可以问他一个问题，您会问什么？为什么想问这个？',
  ...
  },
  {
    ...
    questions: [
      '您看这片草原，先贤们有没有看过同样的风景？',
      '您要是能穿越回去见他一面，您想问他一个什么问题？',
      '您觉得我们在这里立牌，和先贤们当年做的事情，有什么相同的地方？',
      '草原上的风、草、云，您觉得哪个最像他的精神？为什么？',
      '走在这片草原上，您觉得他的心情会是什么样的？',
      '如果他在我们身边，看到我们为立牌忙前忙后，他会说什么？',
      '昌宁的茶山和草原，您觉得他最喜欢哪个地方？',
    ],
  },
  {
    theme: '反思联结',
    ...
    questions: [
      '参加完这次活动，您对这位先贤的理解有没有变化？',
      '如果明年再来，您想选谁做您的榜样？为什么？',
      '您觉得您身上的哪个品质和您的榜样最像？',
      '这次活动里，您什么时候觉得"我好像也有他那样的精神"？',
      '您觉得您的先贤会怎么评价您写的诗？他会为您骄傲吗？',
      '回家以后，您会怎么跟没来的朋友介绍这位先贤？',
      '如果让您给先贤写一句回信，您会写什么？',
    ],
  },
];
